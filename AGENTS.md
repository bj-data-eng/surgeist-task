...
Use this guide for automated work inside the Surgeist task crate repo.

## Crate Role

This repo owns `surgeist-task`, the task scheduling and work-plane contract
crate for Surgeist. Keep work inside this crate unless the user or root
coordinator explicitly directs otherwise.

Before starting, read the local `README.md`, active plan, and any referenced
guidance files. Treat root-authored plans as the source of task scope for
cross-crate work.
