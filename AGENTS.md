# surgeist-task Repository Guide
...
This independent leaf repository owns its manifest, task-domain implementation,
...
`surgeist-task` owns scheduling, cancellation, progress, admission and queueing,
executor-facing policy, and Tokio-backed execution behind those contracts. It
excludes app reducers, UI/window integration, retained bridges, and root event
mapping. Surgeist-to-Surgeist lowering and adapters belong to root, and sibling
